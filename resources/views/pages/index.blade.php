                ...
                <div class="card p-3 col-12 col-md-6 col-lg-4">
                    <div class="card-wrapper ">
                        <div class="card-img">
                            ...
                            <div class="mbr-section-btn text-center"><a href="show()" class="btn btn-black display-4">Learn More</a></div>
                            <img src="/storage/cover_image/{{$item->cover_image}}" alt="Mobirise">
                        </div>
                        <div class="card-box">
