...
<head>
  ...
  <meta name="description" content="This is a website to do blablablah">
...
<body>
  ...
  <section class="menu cid-seN4wnvoHB" once="menu" id="menu2-g">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav nav-dropdown nav-right" data-app-modern-menu="true"><li class="nav-item">
                ...
                <li class="nav-item"><a class="nav-link link text-white display-4" href="/artikels">Artikel Kesehatan</a></li><li class="nav-item">
                    <a class="nav-link link text-white display-4" href="/posko_kesehatans">Data Posko</a>
            ...
            <div class="card p-3 col-12 col-md-6 col-lg-4">
                <div class="card-wrapper ">
                    <div class="card-img">
                        ...
                        <div class="mbr-section-btn text-center"><a href="https://mobiri.se" class="btn btn-black display-4">Learn More</a></div>
...
<section class="cid-seOAgGtHOb" id="footer2-2z">
    ...
    <div class="container">
        <div class="media-container-row content mbr-white">
            ...
            <div class="col-12 col-md-6">
                <div class="google-map"><iframe frameborder="0" style="border:0" src="https://www.google.com/maps/embed/v1/place?key=AIzaSyCZI5F_k6S1k46ujh0SNrapM89f7mJxd30&amp;q=Jl. Teknik Kimia, Keputih, Kec. Sukolilo, Kota SBY, Jawa Timur 60111" allowfullscreen=""></iframe></div>
            </div>
        </div>
